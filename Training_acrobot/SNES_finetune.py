...
MODEL_PATH    = "./models/200M_SNES/best_model.zip"  # policy SAC di partenza
POPSIZE       = 16        # dimensione della popolazione (e num. workers Ray)
N_GENERATIONS = 500       # generazioni totali di SNES

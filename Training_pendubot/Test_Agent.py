...
# poi usa
#model_path = "./models/SNES/best_model.zip"
...
T, X, U = simulator.simulate_and_animate(
    ...
    integrator=integrator,
    save_video=True,
    video_name="sac_pendubot_swing.mp4",
    scale=0.3,
)
...
plot_timeseries(
    ...
    save_to="ts_sac_pendubot_swing.png",
    show=False,
)
...
T, X, U = simulator.simulate_and_animate(
    ...
    integrator=integrator,
    save_video=True,
    video_name="sac_pendubot_stabilize.mp4",
    scale=0.3,
)
...
plot_timeseries(
    ...
    pos_y_lines=[np.pi,0,-np.pi],
    tau_y_lines=[-TORQUE_LIMIT[0],TORQUE_LIMIT[0]],
    save_to="ts_sac_pendubot_stabilize.png",
    show=False,
)